...
let PaymentsController = class PaymentsController {
    ...
    async charge(req, dto) {
        const user = req.user;
        return this.payments.chargeOrder(dto, user?.id);
    }
    async webhook(req, signature, dto) {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)(new zod_pipe_1.ZodPipe(payments_dto_1.ChargeSchema))),
...
__decorate([
    ...
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Headers)('x-culqi-signature')),
    __param(2, (0, common_1.Body)(new zod_pipe_1.ZodPipe(payments_dto_1.WebhookSchema))),
    __metadata("design:type", Function),
